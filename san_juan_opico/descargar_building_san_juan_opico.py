...
Uso:   pip install requests
       python3 descargar_building_san_juan_opico.py

Deja en la carpeta 'datos':
    edificaciones_san_juan_opico.csv
    edificaciones_san_juan_opico.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/edificaciones_san_juan_opico.csv >  datos/todos.csv
