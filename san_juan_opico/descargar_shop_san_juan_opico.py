...
# -*- coding: utf-8 -*-
"""
Descarga los comercios (shop=* de OpenStreetMap) del distrito de SAN JUAN
OPICO, El Salvador.
...
Uso:   pip install requests
       python3 descargar_shop_san_juan_opico.py
...
que al final se pueden unir con:
    head -1 datos/comercios_san_juan_opico.csv >  datos/todos.csv
