...
Uso:   pip install requests
       python3 descargar_santa_tecla.py
...
se pueden unir con:
    head -1 datos/comercios_santa_tecla.csv         >  datos/comercios_todos.csv
...
# Santa Tecla se llamo Nueva San Salvador hasta 2003 y en OpenStreetMap
# todavia aparece con cualquiera de los dos nombres, segun la relacion.
