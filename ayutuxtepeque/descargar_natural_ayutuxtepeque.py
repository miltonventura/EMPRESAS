...
Uso:   pip install requests
       python3 descargar_natural_ayutuxtepeque.py

Deja en la carpeta 'datos':
    naturaleza_ayutuxtepeque.csv
    naturaleza_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/naturaleza_ayutuxtepeque.csv >  datos/todos.csv
