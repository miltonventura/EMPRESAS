...
Uso:   pip install requests
       python3 descargar_historic_ayutuxtepeque.py

Deja en la carpeta 'datos':
    patrimonio_ayutuxtepeque.csv
    patrimonio_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/patrimonio_ayutuxtepeque.csv >  datos/todos.csv
