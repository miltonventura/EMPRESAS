...
Uso:   pip install requests
       python3 descargar_man_made_ayutuxtepeque.py

Deja en la carpeta 'datos':
    infraestructura_ayutuxtepeque.csv
    infraestructura_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/infraestructura_ayutuxtepeque.csv >  datos/todos.csv
