...
Uso:   pip install requests
       python3 descargar_industrial_ayutuxtepeque.py

Deja en la carpeta 'datos':
    industrias_ayutuxtepeque.csv
    industrias_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/industrias_ayutuxtepeque.csv >  datos/todos.csv
