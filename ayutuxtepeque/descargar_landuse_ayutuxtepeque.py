...
Uso:   pip install requests
       python3 descargar_landuse_ayutuxtepeque.py

Deja en la carpeta 'datos':
    usos_de_suelo_ayutuxtepeque.csv
    usos_de_suelo_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/usos_de_suelo_ayutuxtepeque.csv >  datos/todos.csv
