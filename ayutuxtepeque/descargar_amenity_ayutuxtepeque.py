...
distrito de AYUTUXTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_amenity_ayutuxtepeque.py

Deja en la carpeta 'datos':
    servicios_ayutuxtepeque.csv
    servicios_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/servicios_ayutuxtepeque.csv >  datos/todos.csv
