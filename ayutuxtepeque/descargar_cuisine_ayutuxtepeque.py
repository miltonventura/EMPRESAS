...
que sirven comida) del distrito de AYUTUXTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_ayutuxtepeque.py

Deja en la carpeta 'datos':
    gastronomia_ayutuxtepeque.csv
    gastronomia_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_ayutuxtepeque.csv >  datos/todos.csv
