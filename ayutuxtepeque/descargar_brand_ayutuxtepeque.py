...
OpenStreetMap) del distrito de AYUTUXTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_brand_ayutuxtepeque.py

Deja en la carpeta 'datos':
    marcas_ayutuxtepeque.csv
    marcas_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/marcas_ayutuxtepeque.csv >  datos/todos.csv
