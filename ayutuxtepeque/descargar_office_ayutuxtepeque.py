...
del distrito de AYUTUXTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_ayutuxtepeque.py

Deja en la carpeta 'datos':
    oficinas_ayutuxtepeque.csv
    oficinas_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_ayutuxtepeque.csv >  datos/todos.csv
