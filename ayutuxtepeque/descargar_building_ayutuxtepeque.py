...
Uso:   pip install requests
       python3 descargar_building_ayutuxtepeque.py

Deja en la carpeta 'datos':
    edificaciones_ayutuxtepeque.csv
    edificaciones_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/edificaciones_ayutuxtepeque.csv >  datos/todos.csv
