...
Uso:   pip install requests
       python3 descargar_leisure_ayutuxtepeque.py

Deja en la carpeta 'datos':
    recreacion_ayutuxtepeque.csv
    recreacion_ayutuxtepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/recreacion_ayutuxtepeque.csv >  datos/todos.csv
