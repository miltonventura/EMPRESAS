...
del distrito de SAN SALVADOR, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_san_salvador.py

Deja en la carpeta 'datos':
    oficinas_san_salvador.csv
    oficinas_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_san_salvador.csv >  datos/todos.csv
...
BBOX_BUSQUEDA = "13.55,-89.40,13.90,-89.05"
