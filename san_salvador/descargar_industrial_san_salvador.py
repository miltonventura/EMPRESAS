...
Uso:   pip install requests
       python3 descargar_industrial_san_salvador.py

Deja en la carpeta 'datos':
    industrias_san_salvador.csv
    industrias_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/industrias_san_salvador.csv >  datos/todos.csv
