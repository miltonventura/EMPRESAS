...
que sirven comida) del distrito de SAN SALVADOR, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_san_salvador.py

Deja en la carpeta 'datos':
    gastronomia_san_salvador.csv
    gastronomia_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_san_salvador.csv >  datos/todos.csv
