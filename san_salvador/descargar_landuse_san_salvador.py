...
Uso:   pip install requests
       python3 descargar_landuse_san_salvador.py

Deja en la carpeta 'datos':
    usos_de_suelo_san_salvador.csv
    usos_de_suelo_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/usos_de_suelo_san_salvador.csv >  datos/todos.csv
