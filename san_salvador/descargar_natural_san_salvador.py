...
Uso:   pip install requests
       python3 descargar_natural_san_salvador.py

Deja en la carpeta 'datos':
    naturaleza_san_salvador.csv
    naturaleza_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/naturaleza_san_salvador.csv >  datos/todos.csv
