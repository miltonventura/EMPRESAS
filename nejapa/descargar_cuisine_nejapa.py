...
que sirven comida) del distrito de NEJAPA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_nejapa.py

Deja en la carpeta 'datos':
    gastronomia_nejapa.csv
    gastronomia_nejapa.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_nejapa.csv >  datos/todos.csv
