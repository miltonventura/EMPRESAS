...
del distrito de NEJAPA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_nejapa.py

Deja en la carpeta 'datos':
    oficinas_nejapa.csv
    oficinas_nejapa.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_nejapa.csv >  datos/todos.csv
    tail -q -n +2 datos/*_nejapa.csv       >> datos/todos.csv
...
BBOX_BUSQUEDA = "13.65,-89.50,14.10,-89.05"
