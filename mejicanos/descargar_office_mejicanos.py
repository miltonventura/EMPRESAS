...
del distrito de MEJICANOS, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_mejicanos.py

Deja en la carpeta 'datos':
    oficinas_mejicanos.csv
    oficinas_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_mejicanos.csv >  datos/todos.csv
    tail -q -n +2 datos/*_mejicanos.csv       >> datos/todos.csv
