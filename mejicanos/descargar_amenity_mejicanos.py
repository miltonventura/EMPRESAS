...
distrito de MEJICANOS, El Salvador.
...
Uso:   pip install requests
       python3 descargar_amenity_mejicanos.py

Deja en la carpeta 'datos':
    servicios_mejicanos.csv
    servicios_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/servicios_mejicanos.csv >  datos/todos.csv
