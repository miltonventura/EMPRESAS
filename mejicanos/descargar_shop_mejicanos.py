...
# -*- coding: utf-8 -*-
"""
Descarga los comercios (shop=* de OpenStreetMap) del distrito de MEJICANOS,
El Salvador.
...
Uso:   pip install requests
       python3 descargar_shop_mejicanos.py

Deja en la carpeta 'datos':
    comercios_mejicanos.csv
    comercios_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/comercios_mejicanos.csv >  datos/todos.csv
