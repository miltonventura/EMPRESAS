...
Uso:   pip install requests
       python3 descargar_man_made_mejicanos.py

Deja en la carpeta 'datos':
    infraestructura_mejicanos.csv
    infraestructura_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/infraestructura_mejicanos.csv >  datos/todos.csv
