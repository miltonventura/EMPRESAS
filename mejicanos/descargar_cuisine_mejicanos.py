...
que sirven comida) del distrito de MEJICANOS, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_mejicanos.py

Deja en la carpeta 'datos':
    gastronomia_mejicanos.csv
    gastronomia_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_mejicanos.csv >  datos/todos.csv
