...
OpenStreetMap) del distrito de MEJICANOS, El Salvador.
...
Uso:   pip install requests
       python3 descargar_brand_mejicanos.py

Deja en la carpeta 'datos':
    marcas_mejicanos.csv
    marcas_mejicanos.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/marcas_mejicanos.csv >  datos/todos.csv
