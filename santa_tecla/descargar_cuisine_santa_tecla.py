...
que sirven comida) del distrito de SANTA TECLA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_santa_tecla.py

Deja en la carpeta 'datos':
    gastronomia_santa_tecla.csv
    gastronomia_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_santa_tecla.csv >  datos/todos.csv
