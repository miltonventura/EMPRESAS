...
del distrito de SANTA TECLA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_santa_tecla.py

Deja en la carpeta 'datos':
    oficinas_santa_tecla.csv
    oficinas_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_santa_tecla.csv >  datos/todos.csv
    tail -q -n +2 datos/*_santa_tecla.csv       >> datos/todos.csv
...
PATRON = "Santa Tecla|Nueva San Salvador"
...
BBOX_BUSQUEDA = "13.45,-89.45,13.80,-89.15"
