...
distrito de SANTA TECLA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_amenity_santa_tecla.py

Deja en la carpeta 'datos':
    servicios_santa_tecla.csv
    servicios_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/servicios_santa_tecla.csv >  datos/todos.csv
