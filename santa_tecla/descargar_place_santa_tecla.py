...
# -*- coding: utf-8 -*-
"""
Descarga los lugares poblados (place=* de OpenStreetMap) del distrito de
...
Uso:   pip install requests
       python3 descargar_place_santa_tecla.py

Deja en la carpeta 'datos':
    lugares_santa_tecla.csv
    lugares_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/lugares_santa_tecla.csv >  datos/todos.csv
