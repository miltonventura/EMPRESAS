...
Uso:   pip install requests
       python3 descargar_man_made_santa_tecla.py

Deja en la carpeta 'datos':
    infraestructura_santa_tecla.csv
    infraestructura_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/infraestructura_santa_tecla.csv >  datos/todos.csv
