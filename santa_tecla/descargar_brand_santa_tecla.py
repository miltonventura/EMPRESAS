...
OpenStreetMap) del distrito de SANTA TECLA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_brand_santa_tecla.py

Deja en la carpeta 'datos':
    marcas_santa_tecla.csv
    marcas_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/marcas_santa_tecla.csv >  datos/todos.csv
