...
# -*- coding: utf-8 -*-
"""
Descarga los comercios (shop=* de OpenStreetMap) del distrito de SANTA
TECLA, El Salvador.
...
Uso:   pip install requests
       python3 descargar_shop_santa_tecla.py

Deja en la carpeta 'datos':
    comercios_santa_tecla.csv
    comercios_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/comercios_santa_tecla.csv >  datos/todos.csv
