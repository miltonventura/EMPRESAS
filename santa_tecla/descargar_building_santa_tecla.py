...
Uso:   pip install requests
       python3 descargar_building_santa_tecla.py

Deja en la carpeta 'datos':
    edificaciones_santa_tecla.csv
    edificaciones_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/edificaciones_santa_tecla.csv >  datos/todos.csv
