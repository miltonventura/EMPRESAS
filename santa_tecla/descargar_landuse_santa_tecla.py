...
# -*- coding: utf-8 -*-
"""
Descarga los usos de suelo (landuse=* de OpenStreetMap) del distrito de
...
Uso:   pip install requests
       python3 descargar_landuse_santa_tecla.py

Deja en la carpeta 'datos':
    usos_de_suelo_santa_tecla.csv
    usos_de_suelo_santa_tecla.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/usos_de_suelo_santa_tecla.csv >  datos/todos.csv
