...
# -*- coding: utf-8 -*-
"""
Descarga los lugares con marca o cadena comercial identificada
(brand=* de OpenStreetMap) del distrito de SAN SALVADOR, El Salvador.
...
Uso:   pip install requests
       python3 descargar_brand_san_salvador.py

Deja en la carpeta 'datos':
    marcas_san_salvador.csv
    marcas_san_salvador.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/marcas_san_salvador.csv >  datos/todos.csv
