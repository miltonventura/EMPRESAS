...
Uso:   pip install requests
       python3 descargar_leisure_quezaltepeque.py

Deja en la carpeta 'datos':
    recreacion_quezaltepeque.csv
    recreacion_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/recreacion_quezaltepeque.csv >  datos/todos.csv
