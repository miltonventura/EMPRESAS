...
Uso:   pip install requests
       python3 descargar_building_quezaltepeque.py

Deja en la carpeta 'datos':
    edificaciones_quezaltepeque.csv
    edificaciones_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/edificaciones_quezaltepeque.csv >  datos/todos.csv
