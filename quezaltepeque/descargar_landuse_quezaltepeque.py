...
Uso:   pip install requests
       python3 descargar_landuse_quezaltepeque.py

Deja en la carpeta 'datos':
    usos_de_suelo_quezaltepeque.csv
    usos_de_suelo_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/usos_de_suelo_quezaltepeque.csv >  datos/todos.csv
