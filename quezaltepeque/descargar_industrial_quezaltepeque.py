...
Uso:   pip install requests
       python3 descargar_industrial_quezaltepeque.py

Deja en la carpeta 'datos':
    industrias_quezaltepeque.csv
    industrias_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/industrias_quezaltepeque.csv >  datos/todos.csv
