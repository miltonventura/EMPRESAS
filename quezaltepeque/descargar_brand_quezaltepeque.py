...
OpenStreetMap) del distrito de QUEZALTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_brand_quezaltepeque.py

Deja en la carpeta 'datos':
    marcas_quezaltepeque.csv
    marcas_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/marcas_quezaltepeque.csv >  datos/todos.csv
