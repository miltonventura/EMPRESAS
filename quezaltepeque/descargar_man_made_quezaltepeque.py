...
Uso:   pip install requests
       python3 descargar_man_made_quezaltepeque.py

Deja en la carpeta 'datos':
    infraestructura_quezaltepeque.csv
    infraestructura_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/infraestructura_quezaltepeque.csv >  datos/todos.csv
