...
Uso:   pip install requests
       python3 descargar_historic_quezaltepeque.py

Deja en la carpeta 'datos':
    patrimonio_quezaltepeque.csv
    patrimonio_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/patrimonio_quezaltepeque.csv >  datos/todos.csv
