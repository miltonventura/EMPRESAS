...
del distrito de QUEZALTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_quezaltepeque.py

Deja en la carpeta 'datos':
    oficinas_quezaltepeque.csv
    oficinas_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_quezaltepeque.csv >  datos/todos.csv
    tail -q -n +2 datos/*_quezaltepeque.csv       >> datos/todos.csv
...
BBOX_BUSQUEDA = "13.65,-89.50,14.05,-89.05"
