...
distrito de QUEZALTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_amenity_quezaltepeque.py

Deja en la carpeta 'datos':
    servicios_quezaltepeque.csv
    servicios_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/servicios_quezaltepeque.csv >  datos/todos.csv
