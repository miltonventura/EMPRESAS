...
que sirven comida) del distrito de QUEZALTEPEQUE, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_quezaltepeque.py

Deja en la carpeta 'datos':
    gastronomia_quezaltepeque.csv
    gastronomia_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_quezaltepeque.csv >  datos/todos.csv
