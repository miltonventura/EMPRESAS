...
Uso:   pip install requests
       python3 descargar_natural_quezaltepeque.py

Deja en la carpeta 'datos':
    naturaleza_quezaltepeque.csv
    naturaleza_quezaltepeque.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/naturaleza_quezaltepeque.csv >  datos/todos.csv
