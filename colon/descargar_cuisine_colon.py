...
que sirven comida) del distrito de COLÓN, El Salvador.
...
Uso:   pip install requests
       python3 descargar_cuisine_colon.py

Deja en la carpeta 'datos':
    gastronomia_colon.csv
    gastronomia_colon.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/gastronomia_colon.csv >  datos/todos.csv
