...
del distrito de COLÓN, El Salvador.
...
Uso:   pip install requests
       python3 descargar_office_colon.py

Deja en la carpeta 'datos':
    oficinas_colon.csv
    oficinas_colon.geojson

Los CSV de todas las categorias y distritos tienen las mismas columnas, asi
que al final se pueden unir con:
    head -1 datos/oficinas_colon.csv >  datos/todos.csv
    tail -q -n +2 datos/*_colon.csv       >> datos/todos.csv
...
BBOX_BUSQUEDA = "13.50,-89.60,13.95,-89.15"
